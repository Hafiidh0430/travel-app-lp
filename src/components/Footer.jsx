    ...
    <>
      <footer className="footer-container text-white p-[4rem] rounded-[4rem] bg-gray-950">
        <header className="footer-header gap-4 relative flex flex-col items-center">
          <h4 className="text-book w-[46rem] text-center text-2xl">Let’s book today and take advantage of our services. We’re always
          waiting your arrival for 24 hours, don’t miss out for all surprise of us!</h4>
          <div className="cta-btn flex gap-2 items-center">
            <a className="bg-white rounded-full px-4 py-2 text-black text-sm" href="">What a suprise?</a>
            <a className="border border-white px-4 py-2 text-sm rounded-full" href="">Book now</a>
          </div>
          <span className="line absolute bottom-0  top-[11rem] rounded-full w-full h-[1px] bg-white"></span>
        </header>
        ...
        <div className="footer-body h-[10rem] mt-16 flex justify-between">
          ...
          <div className="right-section-footer w-[22rem] h-fit flex flex-wrap gap-6" >
             ...
             <div className="email">
                <h3>Email.</h3>
                <p className="text-sm text-slate-500">stayinajacontactid@gmail.com</p>
             </div>
             <div className="location">
                <h3>Location.</h3>
                <p className="text-sm text-slate-500">Alpha Tower, Sudirman Street No. 45, <br/> 18rd Floor, South Jakarta - 12930.</p>
             </div>
          </div>
        </div>
      </footer>
