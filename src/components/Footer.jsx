    ...
    <>
      <footer className="footer-container text-white p-[4rem] rounded-[4rem] bg-gray-950">
        <header className="footer-header gap-4 relative flex flex-col items-center">
          <h4 className="text-book w-[46rem] text-2xl">Let’s book today and take advantage of our services. We’re always
          ...
          <span className="line absolute bottom-0  top-36 rounded-full w-full h-[1px] bg-white"></span>
        </header>
